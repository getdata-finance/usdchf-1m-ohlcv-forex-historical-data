...
> **Sample on GitHub** · `USDCHF_1m.csv` (55,440 rows, `2026-07-09` -> `2026-09-02`, 5.50 MB). **Full archive on [getdata.finance](https://getdata.finance/datasets/usdchf)** — **9,169,329** `1m` rows (full `1m`: 9,147,305), **11 timeframes**, `2001-11-28` -> `2026-09-02`.
